...
grammar.add_rule(GrammarRule(('vp', 'put', 'object', 'on', 'object'), ('P1', 'P1', 'E1', 'P1', 'E2'), ()))
# object(E1) -> np(E1)
grammar.add_rule(GrammarRule(('object', 'np'), ('E1', 'E1'), ()))
# np(E1) -> quantifier(Q1) nbar(E1)
grammar.add_rule(GrammarRule(('np', 'quantifier', 'nbar'), ('E1', 'Q1', 'E1'), ()))
...
grammar.add_rule(GrammarRule(('quantifier', 'the'), ('Q1', 'Q1'), ()))
# quantifier(Q1) -> all(Q1)
grammar.add_rule(GrammarRule(('quantifier', 'all'), ('Q1', 'Q1'), ()))
# noun(E1) -> block(E1)
grammar.add_rule(GrammarRule(('noun', 'block'), ('E1', 'E1'), ()))
# adjective(A1) -> red(A1)
grammar.add_rule(GrammarRule(('adjective', 'red'), ('A1', 'A1'), ()))
# adjective(A1) -> blue(A1)
grammar.add_rule(GrammarRule(('adjective', 'blue'), ('A1', 'A1'), ()))
