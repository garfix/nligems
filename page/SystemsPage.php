...
class SystemsPage extends FrontEndPage
{
    ...
    protected function getBody()
    {
        ...
        $html = "<p class='intro'>A collection of historic NLI systems. It is meant to give you a quick overview of the field, as a sort of index. The bullet points in the form of a gem - <img src='page/img/gem.png' /> - mark innovations. In the dialogs, H means the human user, and C the computer system.<BR>Note that is a work-in-progress. -- Patrick</p>";
